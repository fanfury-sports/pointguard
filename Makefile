...
docker-build:
	...
	mkdir -p ./build/
	docker cp ethermint:/usr/bin/pointguard ./build/
...
ifeq ($(OS),Windows_NT)
	...
	IF not exist "build/node0/$(ETHERMINT_BINARY)/config/genesis.json" docker run --rm -v $(CURDIR)/build\ethermint\Z pointguard/node "./pointguard testnet --v 4 -o /ethermint --keyring-backend=test --ip-addresses pointguardnode0,pointguardnode1,pointguardnode2,pointguardnode3"
	docker-compose up -d
else
	mkdir -p localnet-setup
	@$(MAKE) localnet-build

	if ! [ -f localnet-setup/node0/$(ETHERMINT_BINARY)/config/genesis.json ]; then docker run --rm -v $(CURDIR)/localnet-setup:/ethermint:Z pointguard/node "./pointguard testnet --v 4 -o /ethermint --keyring-backend=test --ip-addresses pointguardnode0,pointguardnode1,pointguardnode2,pointguardnode3"; fi
	docker-compose up -d
endif
...
localnet-unsafe-reset:
	docker-compose down
ifeq ($(OS),Windows_NT)
	@docker run --rm -v $(CURDIR)\localnet-setup\node0\ethermitd:ethermint\Z pointguard/node "./pointguard unsafe-reset-all --home=/ethermint"
	@docker run --rm -v $(CURDIR)\localnet-setup\node1\ethermitd:ethermint\Z pointguard/node "./pointguard unsafe-reset-all --home=/ethermint"
	@docker run --rm -v $(CURDIR)\localnet-setup\node2\ethermitd:ethermint\Z pointguard/node "./pointguard unsafe-reset-all --home=/ethermint"
	@docker run --rm -v $(CURDIR)\localnet-setup\node3\ethermitd:ethermint\Z pointguard/node "./pointguard unsafe-reset-all --home=/ethermint"
else
	@docker run --rm -v $(CURDIR)/localnet-setup/node0/ethermitd:/ethermint:Z pointguard/node "./pointguard unsafe-reset-all --home=/ethermint"
	@docker run --rm -v $(CURDIR)/localnet-setup/node1/ethermitd:/ethermint:Z pointguard/node "./pointguard unsafe-reset-all --home=/ethermint"
	@docker run --rm -v $(CURDIR)/localnet-setup/node2/ethermitd:/ethermint:Z pointguard/node "./pointguard unsafe-reset-all --home=/ethermint"
	@docker run --rm -v $(CURDIR)/localnet-setup/node3/ethermitd:/ethermint:Z pointguard/node "./pointguard unsafe-reset-all --home=/ethermint"
endif

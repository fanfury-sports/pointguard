			...
			abci.ResponseDeliverTx{
				...
				Events: []abci.Event{
					{Type: "coin_received", Attributes: []abci.EventAttribute{
						{Key: []byte("receiver"), Value: []byte("fury12luku6uxehhak02py4rcz65zu0swh7wjhkakqs")},
						{Key: []byte("amount"), Value: []byte("1252860basetcro")},
					}},
					{Type: "coin_spent", Attributes: []abci.EventAttribute{
						{Key: []byte("spender"), Value: []byte("fury17xpfvakm2amg962yls6f84z3kell8c5lqj20cj")},
						{Key: []byte("amount"), Value: []byte("1252860basetcro")},
					}},
					...
					{Type: "message", Attributes: []abci.EventAttribute{
						...
						{Key: []byte("key"), Value: []byte("fury17xpfvakm2amg962yls6f84z3kell8c5lqj20cj")},
